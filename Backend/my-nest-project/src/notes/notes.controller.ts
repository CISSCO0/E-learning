...
//...........................................................................................................
  ...
  @Post()
  async createByUserId(@Body() createNoteDto: CreateNoteDto) {
    return this.notesService.createByUserId(createNoteDto);
  }
  
  @Put(':id')
  async updateByUserId(@Param('id') id: string, @Body() updateNoteDto: UpdateNoteDto) {
    return this.notesService.updateByUserId(id, updateNoteDto);
  }
  
  @Delete(':id')
  async removeByUserId(@Param('id') id: string) {
    return this.notesService.removeByUserId(id);
  }
  @Get(':id')
async findById(@Param('id') id: string) {
  return this.notesService.findById(id); // Ensure this method is implemented in your service
}
...
async findByCourseAndUser(
  ...
  return this.notesService.findByCourseAndUser(courseId, userId);
}
